...
//    dwt_softreset();
    ...
    while (1)
    {
        ...
        HAL_UART_Transmit(&huart1, (uint8_t*)"01. Frame received or timeout\n\r", 31, 1000);

        if (status_reg & SYS_STATUS_RXFCG)
        {
            HAL_UART_Transmit(&huart1, (uint8_t*)"02. Frame received\n\r", 20, 1000);
            ...
            if ((frame_len == 14) && (rx_buffer[0] == 0xC5) && (rx_buffer[10] == 0x43) && (rx_buffer[11] == 0x2))
            {
                ...
                HAL_UART_Transmit(&huart1, (uint8_t*)"03. Frame OK, send response.\n\r", 30, 1000);
                ...
                HAL_UART_Transmit(&huart1, (uint8_t*)"04. Response sent.\n\r", 20, 1000);
        ...
        {
            HAL_UART_Transmit(&huart1, (uint8_t*)"02. Timeout.\n\r", 14, 1000);
