...
//        lcd_display_str("INIT FAILED");
    ...
    while (1)
    {
        ...
        error=dwt_starttx(DWT_START_TX_IMMEDIATE | DWT_RESPONSE_EXPECTED);
//        HAL_UART_Transmit(&huart1, (uint8_t*)"01. Frame transmitted\n\r", 23, 1000);
        ...
        HAL_UART_Transmit(&huart1, (uint8_t*)"02. Frame received or timeout\n\r", 32, 1000);
        ...
        if (status_reg & SYS_STATUS_RXFCG)
        {
            ...
            HAL_UART_Transmit(&huart1, (uint8_t*)"03. Frame received\n\r", 20, 1000);
            ...
            rx_buffer[frame_len+2] = '\r';
            HAL_UART_Transmit(&huart1, rx_buffer, frame_len+2, 1000);
        ...
        {
            HAL_UART_Transmit(&huart1, (uint8_t*)"04. Error or timeout\n\r", 22, 1000);
