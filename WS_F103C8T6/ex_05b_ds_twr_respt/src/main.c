...
//        lcd_display_str("INIT FAILED");
    ...
    HAL_UART_Transmit(&huart1, (uint8_t*)"Arranque\n\r", 10, 1000);
...
//                        dummy=0;
//                        HAL_UART_Transmit(&huart1, (uint8_t *)&Ra, 4, 1000);
//                        UART_printUint64(Rb, 10);
//                        UART_printUint64(Da, 10);
//                        UART_printUint64(Db, 10);
