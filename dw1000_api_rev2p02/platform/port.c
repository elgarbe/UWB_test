...
{
	SPI1->CR1 &= 0xFFC7;
	SPI1->CR1 |= (0x4 << 3);	//fPCLK/32 -> 48MHz/32 = 1.5Mbps
}
...
{
	// Todo esto es con dudas x q no se si anda bien el osc externo x q no me anda la uart.
	//72/32 = 2.25MHz es muy poco
	//72/16 = 4.5MHz va bien
	//72/8  = 9MHz va bien
	//72/4 = 18MHz va bien
	SPI1->CR1 &= 0xFFC7;
	SPI1->CR1 |= (0x2 << 3);	//fPCLK/4 -> 48MHz/4 = 12Mbps
